...
export default function AddParticipantsPanel({ tournament, allUsers, guestUsername, setGuestUsername, batchGuestCount, setBatchGuestCount, selectedUserId, setSelectedUserId, onAddGuest, onBatchAddGuests, onInvitePlayer, batchLoading = false }: Props) {
    ...
    <div className="bg-[#000000] border border-white/20 p-4 md:p-6 rounded space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <button onClick={onInvitePlayer} className="px-4 h-10 sm:w-auto w-full bg-background border border-white/20 text-white font-semibold text-sm rounded hover:bg-white/10 transition-colors whitespace-nowrap">
            Add User
          </button>
        </div>
      </div>
